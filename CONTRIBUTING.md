Contributing to OurCoin
============================

The OurCoin project operates an open contributor model where anyone is
...
The following applies to code changes to the OurCoin project, and is not to be
confused with overall OurCoin Network Protocol consensus changes.

Whether a pull request is merged into OurCoin rests with the project merge
...
Patches that change OurCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the OurCoin consensus, it must have been
...
The project leader is the release manager for each OurCoin release.
