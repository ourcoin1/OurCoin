...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* OurCoin features */
        {"ourcoin", "masternode", &masternode, true, true, false},
        {"ourcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"ourcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"ourcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"ourcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"ourcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"ourcoin", "startmasternode", &startmasternode, true, true, false},
        {"ourcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"ourcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"ourcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"ourcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"ourcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"ourcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"ourcoin", "mnbudget", &mnbudget, true, true, false},
        {"ourcoin", "preparebudget", &preparebudget, true, true, false},
        {"ourcoin", "submitbudget", &submitbudget, true, true, false},
        {"ourcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"ourcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"ourcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"ourcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"ourcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"ourcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"ourcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"ourcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"ourcoin", "mnsync", &mnsync, true, true, false},
        {"ourcoin", "spork", &spork, true, true, false},
        {"ourcoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"ourcoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use ourcoind, or the -server option to ourcoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> ourcoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:29013/\n";
}
