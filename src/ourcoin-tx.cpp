...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("OurCoin ourcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  ourcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ourcoin transaction") + "\n" +
                               "  ourcoin-tx [options] -create [commands]   " + _("Create hex-encoded ourcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded ourcoin transaction
