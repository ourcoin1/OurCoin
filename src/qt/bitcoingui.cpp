                                                                            ...
                                                                            nWeight(0)
{
    ...
    QString windowTitle = tr("OurCoin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a OurCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and ourcoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About OurCoin"), this);
    aboutAction->setStatusTip(tr("Show information about OurCoin"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for OurCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your OurCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified OurCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a OurCoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the OurCoin help message to get a list with possible OurCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("OurCoin client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("OurCoin"); // default title
