...
/** Utility functions used by the OurCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render OurCoin addresses in monospace font
...
// Parse "ourcoin:" URI into recipient object, return true on successful parsing
