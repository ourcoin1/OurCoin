...
RESOURCES += src/qt/ourcoin.qrc src/qt/ourcoin_locale.qrc

TRANSLATIONS += src/qt/locale/ourcoin_bg.ts \
                src/qt/locale/ourcoin_de.ts \
                src/qt/locale/ourcoin_en.ts \
                src/qt/locale/ourcoin_es.ts \
                src/qt/locale/ourcoin_fi.ts \
                src/qt/locale/ourcoin_fr.ts \
                src/qt/locale/ourcoin_it.ts \
                src/qt/locale/ourcoin_ja.ts \
                src/qt/locale/ourcoin_pl.ts \
                src/qt/locale/ourcoin_pt.ts \
                src/qt/locale/ourcoin_ru.ts \
                src/qt/locale/ourcoin_sk.ts \
                src/qt/locale/ourcoin_sv.ts \
                src/qt/locale/ourcoin_vi.ts \
                src/qt/locale/ourcoin_zh_CN.ts \
                src/qt/locale/ourcoin_zh_TW.ts
