...
In order to support loading of multiple wallets in ourcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is ourcoin.cpp.
...
Changes to ourcoin.cpp
----------------------
ourcoin.cpp is the entry point into ourcoin-qt, and as such, will require some minor modifications to provide hooks for
