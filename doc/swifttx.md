...
This mechanism has been integrated into Bitcore-Node-OurCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/ourcoin1/insight-api-ourcoin#web-socket-api](https://github.com/ourcoin1/insight-api-ourcoin#web-socket-api) 
* API: [https://github.com/ourcoin1/insight-api-ourcoin#swifttx-transactions](https://github.com/ourcoin1/insight-api-ourcoin#swifttx-transactions) 
...
By default, the OurCoin daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the OurCoin daemon:
